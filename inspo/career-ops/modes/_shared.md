...
6. Generate candidate-facing content in the application/JD language: Swedish postings/forms → Swedish CV text, cover letters, application answers, follow-ups, and outreach drafts; English postings/forms → English. If mixed, follow the application form questions. Internal reports may remain English unless the user asks otherwise.
7. Be direct and actionable -- no fluff
8. Use natural professional language for the detected output language. Short sentences, action verbs, no passive voice.
