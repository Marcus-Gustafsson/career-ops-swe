...
**Candidate-facing language rule:** Generated materials that the candidate will send must match the application/JD language. If the job posting or application form is in Swedish, generate the tailored CV text, cover letter, application-question answers, follow-ups, and outreach drafts in Swedish. If the posting/form is in English, generate them in English. If a posting mixes languages, follow the language used in the application questions/form. Internal evaluation reports may remain English unless the user asks for Swedish.
